        ...
        <section className='row footer'>
            <Row className="col-md-11 mx-auto">
                ...
                <Col md={6} lg={3} className="fAboutUs">
                    ...
                    <p className="aboutUsDes">Kosher Code is an enterprise technology and software consulting house headquartered in Kampala, Uganda. We engineer mission-critical solutions for banking, SACCOs, MSMEs, and multi-continental corporations.</p>
            ...
            <p className="copyRight">Copyright &copy; {(new Date()).getFullYear()} <span className="fHighlight">Kosher Code</span>. All rights reserved.</p>
        </section>
    );
};
