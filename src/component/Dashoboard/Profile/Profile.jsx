...
const Profile = () => {
    ...
    return (
        <Col md={6} lg={5} className="mx-auto my-4">
            <div className="bg-white p-4 border text-center" style={{ borderRadius: '0', borderColor: '#E5E0FA', boxShadow: '0 4px 20px rgba(115, 85, 247, 0.06)' }}>
                ...
                <div className="p-3 mb-4 text-start border" style={{ backgroundColor: '#FAF8FF', borderRadius: '0', borderColor: '#E5E0FA' }}>
                ...
                <div className="d-grid gap-3">
                    {admin ? (
                        <Link to="/admin/orders" className="btn text-white py-2.5" style={{ backgroundColor: '#7355F7', borderRadius: '0', fontWeight: 600 }}>
                            <FontAwesomeIcon icon={faList} className="me-2" /> View Incoming Requests
                        </Link>
                    ) : (
                        <Link to="/client/book" className="btn text-white py-2.5" style={{ backgroundColor: '#7355F7', borderRadius: '0', fontWeight: 600 }}>
